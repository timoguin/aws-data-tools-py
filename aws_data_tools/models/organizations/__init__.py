...
class Organization(ModelBase):
    ...
    _parent_child_tree: Dict[str, ParChild] = field(default=None, init=False, repr=False)
    _child_parent_tree: Dict[str, ParChild] = field(default=None, init=False, repr=False)
    _policy_target_tree: Dict[str, ParChild] = field(default=None, init=False, repr=False)
